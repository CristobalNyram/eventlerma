            ...
            <div class="row">
                ...
                {{-- <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-event-area mb-30">
                        <div class="event-thumbnail">
                            <img src="{{ asset('assets/home_page/') }}/img/bg-img/{{ $event->image }}" alt="">
                        </div>
                        <div class="event-text">
                            <h4>{{ $event->name }}</h4>
                            <div class="event-meta-data">
                                <a href="#" class="event-place">{{ $event->place }}</a>
                                <a href="#" class="event-date">{{ $event->date }}</a>
                            </div>
                            <a href="#" class="btn see-more-btn">Detalles</a>
                        </div>
                    </div>
                </div> --}}
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="single-event-area mb-30">
                        ...
                        <div class="event-text">
                            <h4>{{ strlen($event->name) > 25 ? substr($event->name, 0, 25) . '...' : $event->name }}</h4>
                            <div class="event-meta-data">
                                <a href="#" class="event-place">{{ $event->time }}</a>
                                <a href="#" class="event-date">{{ $event->date }}</a>
                            </div>
                            <a href="{{ route('home_page_event_detail', ['slug' => $event->slug]) }}" class="btn see-more-btn">Mirar evento</a>
                        </div>
                    </div>
                </div>
                @endforeach
